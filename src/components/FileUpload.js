...
const auth =
    'Basic ' + Buffer.from('2NfFZdmLyoIYtTRDrz4U5mMuBaV' + ':' + '66b4f47b16ff548340d419d02b35f210').toString('base64');
const client = create({
    host: 'ipfs.infura.io',
    port: 5001,
    protocol: 'https',
...
//   auth: {
//     "username": "2NfFZdmLyoIYtTRDrz4U5mMuBaV",
//     "password": "66b4f47b16ff548340d419d02b35f210"
//   }
// });
...
const FileUpload = (props) => {
  ...
  const loadBlockhainData=async()=>{
    const web3 = new Web3(Web3.givenProvider || "https://eth-sepolia.g.alchemy.com/v2/-2775blyNaPMhTvhfMTNTfaiaSOXRG4F");
  ...
  const formSubmission = async (e) => {
    ...
    try {
      ...
      const url = `https://gateway.pinata.cloud/ipfs/${added.cid.toString()}/${filename}`;
